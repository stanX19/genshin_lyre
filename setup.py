...
if str(parent_path) != str(destination_path):
    ...
    if os.path.exists(os.path.join(destination_path, "app//genshin_lyre.py")):
        print_cmd_color("White",f"... genshin_lyre is saved at {destination_path} ,you can now delete the original file")
...
if os.path.exists(os.path.join(new_parent_path, "genshin_lyre.bat")):
    ...
    print_cmd_color("DarkRed",f"Failed to create activation file at {new_parent_path}, please contact me if you see this message")
    time.sleep(3600)
...
print("Finally go to desktop and double click the shortcut, you should see a list of songs and instructions\nyou can now close this program")
